...
model1.wv.save_word2vec_format('/home/lingfengzhang/Code/Sync/MasterThesis/Model/W-CBOW-Stem.bin.gz', binary=True)
model1.wv.save_word2vec_format('/home/lingfengzhang/Code/Sync/MasterThesis/Model/W-CBOW-Stem.txt', binary=False)
model1.save('/home/lingfengzhang/Code/Sync/MasterThesis/Model/W-CBOW-Stem.bin')
print('Done Saving Model1')
#####
model2.wv.save_word2vec_format('/home/lingfengzhang/Code/Sync/MasterThesis/Model/W-Skip-Stem.gz', binary=True)
model2.wv.save_word2vec_format('/home/lingfengzhang/Code/Sync/MasterThesis/Model/W-Skip-Stem.txt', binary=False)
model1.save('/home/lingfengzhang/Code/Sync/MasterThesis/Model/W-Skip-Stem.bin')
