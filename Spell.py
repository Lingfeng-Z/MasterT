...
class Spell:
    def __init__(self, News):
        ...
        News['content'] = News['content'].apply(lambda x: self.correct_spelling(x, mispell_dict))
        #############################
        ##Contraction
        #############################
        contraction_mapping = {
        ...
        News['content'] = News['content'].apply(lambda x: self.clean_contractions(x, contraction_mapping))
    ...
    def known_contractions(self, embed):
        known = []
        for contract in self.contraction_mapping:
