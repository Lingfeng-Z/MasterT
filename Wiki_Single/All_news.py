...
News['SECTION_TEXT'] = News['SECTION_TEXT'].apply(lambda x: correct_spelling(x, mispell_dict))
...
News['SECTION_TEXT'] = News['SECTION_TEXT'].apply(lambda x: clean_contractions(x, contraction_mapping))
...
News['SECTION_TEXT'] = News['SECTION_TEXT'].apply(lambda x: clean_special_chars(x, punct, punct_mapping))
