...
model1.wv.save_word2vec_format('/home/lingfengzhang/Code/Sync/MasterThesis/Model/Wiki-W-CBOW-Stop.bin.gz', binary=True)
model1.wv.save_word2vec_format('/home/lingfengzhang/Code/Sync/MasterThesis/Model/Wiki-W-CBOW-Stop.txt', binary=False)
model1.save('/home/lingfengzhang/Code/Sync/MasterThesis/Model/Wiki-W-CBOW-Stop.bin')
print('Done Saving Model1')
#####
model2.wv.save_word2vec_format('/home/lingfengzhang/Code/Sync/MasterThesis/Model/Wiki-W-Skip-Stop.bin.gz', binary=True)
model2.wv.save_word2vec_format('/home/lingfengzhang/Code/Sync/MasterThesis/Model/Wiki-W-Skip-Stop.txt', binary=False)
model2.save('/home/lingfengzhang/Code/Sync/MasterThesis/Model/Wiki-W-Skip-Stop.bin')
